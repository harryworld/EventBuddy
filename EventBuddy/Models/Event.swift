...
@Observable class EventStore {
    ...
    private func loadWWDCEvents() {
        ...
        events.append(Event(name: "A Vision Pro Spatial Art Experience", dateTime: "9:00am-18:00pm", description: "Flatland: Mixed Reality Dreams", day: "Sunday, June 8th", type: .event))
        ...
        events.append(Event(name: "The French Dinner", dateTime: "7:00pm-10:30pm", description: "🇫🇷🇨🇦🇱🇺🇧🇪 (requires registration)", day: "Monday, June 9th", type: .social))
        events.append(Event(name: "A Vision Pro Spatial Art Experience", dateTime: "9:00am-18:00pm", description: "Flatland: Mixed Reality Dreams", day: "Monday, June 9th", type: .event))
        ...
        events.append(Event(name: "A Vision Pro Spatial Art Experience", dateTime: "9:00am-18:00pm", description: "Flatland: Mixed Reality Dreams", day: "Tuesday, June 10th", type: .event))
        ...
        events.append(Event(name: "A Vision Pro Spatial Art Experience", dateTime: "9:00am-18:00pm", description: "Flatland: Mixed Reality Dreams", day: "Wednesday, June 11th", type: .event))
        ...
        events.append(Event(name: "A Vision Pro Spatial Art Experience", dateTime: "9:00am-18:00pm", description: "Flatland: Mixed Reality Dreams", day: "Thursday, June 12th", type: .event))
